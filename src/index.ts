...
interface JsonSchema {
  ...
  items?: { type: string; properties?: { [key: string]: any }; };
  required?: string[]; // Marking as optional since it can be undefined initially
}

const generateJsonSchema = (jsonObject: any): JsonSchema => {
  ...
  const processObject = (obj: JsonObject, required: string[] = []): { [key: string]: any } => {
